package com.adjt.chefmanagerapi.infrastructure.persistence.mapper;

import com.adjt.chefmanagerapi.domain.Usuario;
import com.adjt.chefmanagerapi.infrastructure.persistence.usuario.UsuarioEntity;
...
public interface UsuarioPersistenceMapper {
    ...
    @Mappings({
            ...
            @Mapping(target = "tipo", expression = "java(com.adjt.chefmanagerapi.domain.TipoUsuario.valueOf(entity.getTipo()))"),
            @Mapping(source = "senha", target = "senha")
    })
